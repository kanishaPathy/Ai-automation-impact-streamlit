...
if comparison_df.empty:
    ...
    fig_sector_ai, ax_ai = plt.subplots(figsize=(6, 3))
    ...
    fig_sector_auto, ax_auto = plt.subplots(figsize=(6, 3))
    ...
    fig_impact, ax_impact = plt.subplots(figsize=(6, 3))
...
if sector_df.empty:
    ...
    fig_sector, ax_sector = plt.subplots(figsize=(6, 3))
...
fig1 = px.line(filtered_df, x="Year", y=["Avg_PreAI", "Avg_PostAI", "Skills_Gap"], labels={"value": "Impact/Gap"}, title="AI's Impact on Unemployment and Skills Gap", width=600, height=300)
st.plotly_chart(fig1)

# AI Adoption vs Sector Growth
st.subheader("AI Adoption vs Sector Growth")
fig2 = px.bar(filtered_df, x="Year", y=["AI_Adoption_Rate", "Sector_Growth_Decline"], barmode="group", title="AI Adoption Rate vs Sector Growth Decline", width=600, height=300)
