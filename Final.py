...
fig1, ax1 = plt.subplots(figsize=(8, 3))  # Adjusted the figure size
...
fig2, ax2 = plt.subplots(figsize=(8, 3))  # Adjusted the figure size
bar_width = 0.35
...
fig3, ax3 = plt.subplots(figsize=(8, 3))  # Adjusted the figure size
...
fig4, ax4 = plt.subplots(figsize=(8, 3))  # Adjusted the figure size
bar_width = 0.4
...
fig5, ax5 = plt.subplots(figsize=(8, 3))  # Adjusted the figure size
...
fig6, ax6 = plt.subplots(figsize=(8, 3))  # Adjusted the figure size
...
fig7, ax7 = plt.subplots(figsize=(8, 3))  # Adjusted the figure size
...
fig1 = px.line(filtered_df, x="Year", y=["Avg_PreAI", "Avg_PostAI", "Skills_Gap"], labels={"value": "Impact/Gap"}, title="AI's Impact on Unemployment and Skills Gap")
st.plotly_chart(fig1)

# AI Adoption vs Sector Growth
st.subheader("AI Adoption vs Sector Growth")
fig2 = px.bar(filtered_df, x="Year", y=["AI_Adoption_Rate", "Sector_Growth_Decline"], barmode="group", title="AI Adoption Rate vs Sector Growth Decline")
