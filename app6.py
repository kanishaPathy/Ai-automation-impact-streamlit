...
ax1.set_ylabel('Average Automation Impact Score')  # Updated y-axis label
...
plt.xlabel('Year')
plt.ylabel('Unemployment Impact Score')  # Updated y-axis label
plt.legend()
st.pyplot(fig2)
...
ax3.set_ylabel("Average Unemployment Impact Score")  # Updated y-axis label
ax3.set_xlabel("Year")
st.pyplot(fig3)
...
plt.ylabel('Education Level Impact Score')  # Updated y-axis label
plt.legend()
st.pyplot(fig4)
